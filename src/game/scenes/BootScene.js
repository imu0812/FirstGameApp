...
import frostTotemIconImage from '../../assets/frost_totem.svg';
import frostTotemBodyImage from '../../assets/frost_totem.png';
import frostTotemPulseImage from '../../assets/frost_totem_pulse.png';
...
import frostTotemCastAudioMp3 from '../../assets/audio/frost_totem_cast.mp3';
...
export class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('frost_totem_icon', frostTotemIconImage);
    this.load.image('frost_totem_body', frostTotemBodyImage);
    this.load.image('frost_totem_pulse', frostTotemPulseImage);
    ...
    this.load.audio('frost_totem_cast_sfx', frostTotemCastAudioMp3);
  ...
  createTextures() {
    ...
    graphics.clear();
    graphics.fillStyle(0x98ebff, 0.96);
    graphics.beginPath();
    ...
    graphics.closePath();
    graphics.fillPath();
    graphics.lineStyle(2, 0xefffff, 0.95);
    graphics.strokePath();
    graphics.generateTexture('frost_totem_shard_placeholder', 32, 32);
